angular.module('CanvasViewer', []).directive('canvasViewer', ['$window', '$http', '$timeout', '$q', function ($window, $http, $timeout, $q) {
  ...
  return {
    ...
    '<button class="btn btn-info" ng-click="options.controls.numPage=options.controls.numPage-1" ng-hide="options.controls.totalPage==1" title="Previous Page"><i class="fa fa-minus"></i></button>' +
    ...
    '<button class="btn btn-info" ng-click="options.controls.numPage=options.controls.numPage+1" ng-hide="options.controls.totalPage==1" title="Next Page"><i class="fa fa-plus"></i></button>' +
    ...
    '<button class="btn btn-info" ng-click="zoom(1)" ng-hide="options.controls.disableZoom" title="Zoom in"><i class="fa fa-search-plus"></i></button></div>' +
    ...
    '<button class="btn btn-info" ng-click="play()" title="Play"><i class="fa fa-play"></i></button></div>' +
    '</div>',
    // templateUrl: '',
    // replace: true,
    // transclude: true,
